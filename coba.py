...
st.set_page_config(layout="wide", page_title="Dashboard Susenas")

# Judul utama dashboard
st.title('📊 Dashboard Analisis Data Susenas')
st.write('Aplikasi ini memungkinkan Anda untuk memfilter dan memvisualisasikan data Susenas berdasarkan kecamatan, desa, dan variabel yang dipilih.')

# --- Langkah 1: Upload File ---
st.header('Langkah 1: Upload Dataset Susenas Anda')
