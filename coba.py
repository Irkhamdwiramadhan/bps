...
st.set_page_config(
    layout="wide",
    page_title="Dashboard Analisis Susenas",
    page_icon="📊"
)

# --- JUDUL UTAMA DASHBOARD ---
st.title('📊 Dashboard Analisis Data')
st.write('Aplikasi interaktif untuk analisis cepat data Survei Sosial Ekonomi Nasional (Susenas).')
...
if uploaded_file is None:
    st.info("Silakan unggah file dataset Susenas Anda di sidebar untuk memulai analisis.")
